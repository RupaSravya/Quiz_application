...
public class MainActivity8 extends AppCompatActivity {
    ...
    private void getQuizQuestion(ArrayList<quizmodal> quizModalArrayList) {
        quizModalArrayList.add(new quizmodal ( "Automatic type conversion is possible in which of the possible cases?", "Byte to int", "Int to long", "Long to int", "Short to int", "Int to long"));
        quizModalArrayList.add(new quizmodal ( "Select the valid statement.","char[] ch = new char(5",  "char[] ch = new char[5]",  "char[] ch = new char()", "char[] ch = new char[]", "char[] ch = new char[5]"));
        quizModalArrayList.add(new quizmodal ( "Arrays in java are-", "Object references",  "Objects ", "Primitive data type", "None", " Objects"));
